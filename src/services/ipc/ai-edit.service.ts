...
export const aiEditService = {
  ...
  createSnapshot(payload: IAiEditCreateSnapshotRequest): Promise<IAiEditCreateSnapshotPayload> {
  ...
  restoreSnapshot(payload: IAiEditRestoreSnapshotRequest): Promise<IAiEditRestoreSnapshotPayload> {
    return tauriService.aiEditRestoreSnapshot(payload);
  },
  undoOperation(payload: IAiEditUndoOperationRequest): Promise<IAiEditUndoOperationPayload> {
